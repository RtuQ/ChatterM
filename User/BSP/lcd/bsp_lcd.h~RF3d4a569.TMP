...
/*根据液晶数据手册的参数配置*/
#define HBP  40		//HSYNC后的无效像素
#define VBP  8		//VSYNC后的无效行数

#define HSW   1		//HSYNC宽度
#define VSW   1		//VSYNC宽度

#define HFP  5		//HSYNC前的无效像素
#define VFP   8		//VSYNC前的无效行数
...
#define LCD_BUFFER_OFFSET          ((uint32_t)480*272*2)

#define SDRAM_APP_BUF     (LCD_FRAME_BUFFER + 8 * 1024 * 1024)
...
#define LCD_BL_ON()               GPIO_SetBits(LTDC_BL_GPIO_PORT,LTDC_BL_GPIO_PIN)
#define LCD_BL_OFF()              GPIO_ResetBits(LTDC_BL_GPIO_PORT,LTDC_BL_GPIO_PIN)
