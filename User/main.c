...
//	LCD_DisplayStringLine(LINE(7),(uint8_t* )dispBuff);
  ...
  LCD_DisplayStringLine(LINE(1),(uint8_t* )"Draw line:");
  
	LCD_SetColors(LCD_COLOR_RED,LCD_COLOR_BLACK);
  LCD_DrawUniLine(0,2,375,2);  
//  LCD_DrawUniLine(50,150,375,150);
...
//	
//	LCD_SetColors(LCD_COLOR_BLACK,LCD_COLOR_BLACK);
//  LCD_DrawFullRect(0,100,LCD_PIXEL_WIDTH,LCD_PIXEL_HEIGHT-100);
